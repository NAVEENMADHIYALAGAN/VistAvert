...
# Load dataset
dataset = pd.read_csv(r'C:\Users\navee\OneDrive\Desktop\Project_Main\WEBSITE_Map\updated_dataset.csv')
...
def calculate():
    ...
    source_weather = "Static weather data for source"
    destination_weather = "Static weather data for destination"
...
def calculate_risk(source_cluster, destination_cluster):
    # Assign fixed risk percentage based on the clusters of source and destination
    risk_percentages = {
